...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-^2hw&9%6^^n7nqr8x$wu(xa7d2hv#=-od7pcspqsn#r5%v4$j(')
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='calorie_tracker'),
            'USER': config('DB_USER', default='calorie_user'),
